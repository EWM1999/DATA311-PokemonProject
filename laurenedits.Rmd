...
attach(pokemon) 
sp <- scatterplot3d(HP,Defense,Pr_Male, pch=16, highlight.3d=TRUE,
...
nnpokemon<-neuralnet(isLegendary~Defense+Pr_Male+Attack+HP,data=pokemon, hidden=2,act.fct = "logistic",
                linear.output = FALSE)
plotnet(nnpokemon)
```
