...
pTab<-cbind(tote,hp,att,def,spa,spd,spe,hei,wei,cat,leg,nlg)
```

```{r}
col<-c("Total","HP","Attack","Defense","Sp_Atk","Sp_Def","Speed","Height_m","Weight_kg","Catch_Rate","Legend","!Legend")
